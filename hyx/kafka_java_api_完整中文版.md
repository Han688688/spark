...
| ConsumerRecord | `ConsumerRecord(..., Optional<Short> delivery计数)` | Full constructor with delivery count |
...
| Module | Main Classes | Methods 计数 |
|--------|--------------|---------------|
| Producer API | 5 | ~40 |
| Consumer API | 8 | ~120 |
