...
> **文档特点**:
> - 包含Kafka所有public Java API（591个方法，43个类）
> - 核心类提供完整可运行示例
> - 按业务分类组织，便于测试覆盖
> - 基于Kafka 4.2.0版本

> **API统计**:
> - Producer API: 15类，约150方法
> - Consumer API: 8类，约100方法
> - Admin API: 20+类，约200方法
> - Streams API: 10+类，约200方法
> - Connect API: 10+类，约100方法
> - Common API: 15类，约150方法
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                System.out.println("收到: " + record.key() + "=" + record.value());
            }
        }
    }
}
